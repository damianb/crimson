...
exports.entryTemplate = jade.compile (fs.readFileSync './assets/templates/entries.jade'), { filename: './assets/templates/entries.jade' }

exports.counter = (_field, _display, max) ->
	field = $(_field)
	display = $(_display)
...
exports.display = (state) ->
	...
	if state is 'load'
		...
		exports.loadThrob(false)

throb = null
exports.throbber = (start = true) ->
	if !!start
		current = length = 1
		throbFn = =>
			if current is 5
